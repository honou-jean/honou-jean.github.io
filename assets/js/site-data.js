...
window.SITE_DATA = {
  ...
  projects: [
    ...
    {
      slug: "conservation-law-shocks",
      number: "05",
      featured: false,
      theme: "scientific",
      coverImage: { src: "assets/images/projects/conservation-law-shocks/cover.jpg", alt: { fr: "Comparaison de la solution exacte et de la solution numérique par le schéma de Lax-Wendroff, montrant un choc bien localisé avec une légère oscillation numérique.", en: "Comparison of the exact and the Lax-Wendroff numerical solution, showing a well-located shock with a slight numerical oscillation." } },
      media: [],
      category: { fr: "Mathématiques appliquées", en: "Applied Mathematics" },
      title: { fr: "Ondes de choc dans une loi de conservation scalaire", en: "Shock Waves in a Scalar Conservation Law" },
      subtitle: { fr: "Méthode des caractéristiques, relation de Rankine-Hugoniot et schéma de Lax-Wendroff", en: "Method of characteristics, Rankine-Hugoniot relation and the Lax-Wendroff scheme" },
      description: { fr: "Étude d’une loi de conservation scalaire non linéaire (flux de type trafic routier) : formation d’un choc par la méthode des caractéristiques, relation de Rankine-Hugoniot, puis validation numérique par le schéma de Lax-Wendroff.", en: "Study of a nonlinear scalar conservation law (traffic-flow-type flux): shock formation via the method of characteristics, the Rankine-Hugoniot relation, and numerical validation with the Lax-Wendroff scheme." },
      technologies: ["Python", "NumPy", "Matplotlib", "SciPy"],
      year: "2025-2026",
      status: "completed",
      categories: ["scientific-computing"],
      href: "projects/conservation-law-shocks.html"
    }
  ],
  ...
  projectDetails: {
    "multimodal-biometrics": {
      ...
      title: { fr: "Conception et développement d’un système d’identification biométrique multimodal", en: "Design and Development of a Multimodal Biometric Identification System" },
      subtitle: { fr: "Reconnaissance faciale • Reconnaissance vocale • OCR", en: "Facial Recognition • Voice Recognition • OCR" },
      lead: { fr: "Un système combinant l’analyse du visage, de la voix et de documents dans une architecture de décision multimodale.", en: "A system combining facial, voice and document analysis in a multimodal decision architecture." },
      year: "2025",
      status: "completed",
      technologies: ["Python", "FaceNet", "Wav2Vec2.0", "EasyOCR", "Tkinter"],
      sections: [
        ...
        { title: { fr: "Fusion multimodale", en: "Multimodal fusion" }, body: { fr: "Le système combine les trois modalités pour la décision finale. Sur l’échantillon de validation (10 sujets, 500 images par test facial, 30 échantillons vocaux, documents d’identité pour l’OCR), la précision mesurée est de 85 % pour la reconnaissance faciale en conditions normales, 93,3 % pour la reconnaissance vocale en environnement silencieux (70 % en environnement bruyant), et 88 % pour l’extraction OCR sur documents d’identité.", en: "The system combines the three modalities for the final decision. On the validation sample (10 subjects, 500 images per facial test, 30 voice samples, ID documents for OCR), measured accuracy was 85% for facial recognition under normal conditions, 93.3% for voice recognition in a quiet environment (70% in a noisy one), and 88% for OCR extraction on identity documents." } },
        { title: { fr: "Simulateur de fusion", en: "Fusion simulator" }, type: "interactive", component: "fusion-simulator", body: { fr: "Ajustez trois scores de confiance illustratifs et un seuil d’acceptation pour voir la fusion pondérée et la courbe ROC se recalculer en direct.", en: "Adjust three illustrative confidence scores and an acceptance threshold to watch the weighted fusion and ROC curve recompute live." }, note: { fr: "Scores et courbe ROC synthétiques, à visée pédagogique : ce ne sont pas les résultats réels du projet (voir la section précédente et le PDF ci-dessous pour les chiffres mesurés).", en: "Synthetic scores and ROC curve, for illustration purposes: not the project's real results (see the previous section and the PDF below for the measured figures)." } },
        { title: { fr: "Limites & suite", en: "Limitations & next steps" }, body: { fr: "La précision chute avec des accessoires occultant le visage (70 %), en faible luminosité (65 %) ou au-delà de 2 m de la caméra (60 %) ; la reconnaissance vocale se dégrade en environnement bruyant (70 % contre 93,3 % en silence) ; l’OCR interprète mal certains caractères spéciaux ou italiques. Pistes retenues : seuils adaptatifs et prétraitement d’image pour le visage, filtrage du bruit et meilleurs microphones pour la voix, modèles OCR spécialisés pour les documents d’identité.", en: "Accuracy drops with face-occluding accessories (70%), low light (65%), or a camera distance beyond 2 m (60%); voice recognition degrades in noisy environments (70% vs. 93.3% in silence); OCR misreads some special or italic characters. Next steps identified: adaptive thresholds and image pre-processing for facial recognition, noise filtering and better microphones for voice, and OCR models specialised for identity documents." } }
      ],
      documents: [
        { type: "pdf", label: { fr: "Rapport du projet (PDF)", en: "Project report (PDF)" }, href: "assets/documents/reports/multimodal-biometrics-report.pdf", available: true },
        { type: "pptx", label: { fr: "Présentation du projet (PPTX)", en: "Project presentation (PPTX)" }, href: "assets/documents/presentations/multimodal-biometrics-presentation.pptx", available: true },
        { type: "repository", label: { fr: "Code source (GitHub)", en: "Source code (GitHub)" }, href: "https://github.com/honou-jean/BioID-vision-Systeme-identification-biometrique-multimodale", available: true }
      ]
    },
    "poisson-processes": {
      number: "02",
      ...
      documents: [
        { type: "pdf", label: { fr: "Rapport complet (PDF)", en: "Full report (PDF)" }, href: "assets/documents/reports/poisson-processes-report.pdf", available: true },
        { type: "pdf", label: { fr: "Support de présentation (PDF)", en: "Presentation slides (PDF)" }, href: "assets/documents/presentations/poisson-processes-presentation.pdf", available: true },
        { type: "repository", label: { fr: "Code source (GitHub)", en: "Source code (GitHub)" }, href: "https://github.com/honou-jean/Modelisation-stochastique-des-flux-d-evenements-par-processus-de-poisson", available: true }
      ]
    },
    ...
    "scientific-computing": {
      ...
      title: { fr: "Résolution d’un problème de réaction-diffusion par éléments finis", en: "Solving a Reaction–Diffusion Problem with the Finite Element Method" },
      subtitle: { fr: "Maillages DistMesh, assemblage éléments finis P1 et validation de la convergence", en: "DistMesh meshing, P1 finite-element assembly and convergence validation" },
      lead: { fr: "Résolution par éléments finis d’un problème elliptique de réaction-diffusion sur un domaine à géométrie non triviale.", en: "Solving an elliptic reaction–diffusion problem by the finite element method on a non-trivial domain." },
      status: "completed",
      technologies: ["MATLAB", "DistMesh"],
      sections: [
        ...
        { title: { fr: "Assemblage éléments finis et résolution", en: "Finite-element assembly and solve" }, body: { fr: "La formulation faible du problème est discrétisée sur l’espace Vh des fonctions P1 continues, affines par triangle et nulles au bord. La matrice A et le second membre b sont assemblés triangle par triangle, avec une partie réaction (matrice de masse locale 2-1-1/1-2-1/1-1-2) et une partie diffusion (gradients des fonctions chapeau), h, ε et f étant évalués au barycentre de chaque triangle, ce qui donne le système linéaire AU = b résolu sur chacun des trois maillages.", en: "The problem's weak formulation is discretised on the space Vh of continuous, piecewise-linear (P1) functions that vanish on the boundary. The matrix A and right-hand side b are assembled triangle by triangle, with a reaction part (local 2-1-1/1-2-1/1-1-2 mass matrix) and a diffusion part (gradients of the hat functions), with h, ε and f evaluated at each triangle's barycentre, yielding the linear system AU = b solved on each of the three meshes." } },
        { title: { fr: "Résultats de convergence", en: "Convergence results" }, body: { fr: "La solution approchée uh est comparée à la solution exacte manufacturée aux nœuds du maillage. L’erreur maximale passe de 1,50×10⁻² (89 nœuds intérieurs) à 1,22×10⁻³ (433 nœuds intérieurs), et l’erreur RMS de 2,32×10⁻³ à 2,92×10⁻⁴, pour un ordre de convergence observé compris entre 3 et 4, confirmant que la solution éléments finis converge vers la solution exacte à mesure que le maillage se raffine.", en: "The approximate solution uh is compared with the manufactured exact solution at the mesh nodes. The maximum error drops from 1.50×10⁻² (89 interior nodes) to 1.22×10⁻³ (433 interior nodes), and the RMS error from 2.32×10⁻³ to 2.92×10⁻⁴, for an observed convergence order between 3 and 4, confirming that the finite-element solution converges to the exact solution as the mesh is refined." }, images: [
      ...
      documents: [
        ...
        { type: "repository", label: { fr: "Code source (GitHub)", en: "Source code (GitHub)" }, href: "https://github.com/honou-jean/fem-reaction-diffusion-distmesh", available: true }
      ]
    },
    "conservation-law-shocks": {
      number: "05",
      coverImage: { src: "assets/images/projects/conservation-law-shocks/cover.jpg", alt: { fr: "Comparaison de la solution exacte et de la solution numérique par le schéma de Lax-Wendroff, montrant un choc bien localisé avec une légère oscillation numérique.", en: "Comparison of the exact and the Lax-Wendroff numerical solution, showing a well-located shock with a slight numerical oscillation." } },
      media: [],
      category: { fr: "Mathématiques appliquées", en: "Applied Mathematics" },
      title: { fr: "Ondes de choc dans une loi de conservation scalaire", en: "Shock Waves in a Scalar Conservation Law" },
      subtitle: { fr: "Méthode des caractéristiques, relation de Rankine-Hugoniot et schéma de Lax-Wendroff", en: "Method of characteristics, Rankine-Hugoniot relation and the Lax-Wendroff scheme" },
      lead: { fr: "Étude d’une loi de conservation scalaire non linéaire (flux de type trafic routier) : formation d’un choc, relation de Rankine-Hugoniot, puis validation numérique par le schéma de Lax-Wendroff.", en: "Study of a nonlinear scalar conservation law (traffic-flow-type flux): shock formation, the Rankine-Hugoniot relation, and numerical validation with the Lax-Wendroff scheme." },
      status: "completed",
      technologies: ["Python", "NumPy", "Matplotlib", "SciPy"],
      sections: [
        { title: { fr: "Contexte & objectif", en: "Context & objective" }, body: { fr: "Une densité de véhicules ρ circule selon la loi de conservation ∂ₜρ + ∂ₓq = 0, avec un débit q = G(ρ) = cρ(1 − ρ/ρ₁) du type modèle de trafic routier de Greenshields (flux nul aux deux extrêmes de densité, maximal à mi-charge). Après le changement de variable u = ρ/ρ₁, le problème se ramène à la loi de conservation normalisée ∂ₜu + ∂ₓ(u(1 − u)) = 0, puis à sa forme non conservative ∂ₜu + (1 − 2u)∂ₓu = 0.", en: "A vehicle density ρ follows the conservation law ∂ₜρ + ∂ₓq = 0, with a flow rate q = G(ρ) = cρ(1 − ρ/ρ₁) of the Greenshields traffic-flow type (zero flux at both density extremes, maximal at half load). After the change of variable u = ρ/ρ₁, the problem reduces to the normalised conservation law ∂ₜu + ∂ₓ(u(1 − u)) = 0, then to its non-conservative form ∂ₜu + (1 − 2u)∂ₓu = 0." } },
        { title: { fr: "Méthode des caractéristiques", en: "Method of characteristics" }, body: { fr: "Pour une donnée initiale u₀, les droites caractéristiques issues de chaque point ξ suivent x(t) = ξ + (1 − 2u₀(ξ))t. Tant que ces droites ne se croisent pas, la solution reste régulière ; leur premier croisement définit le temps critique T*, calculé ici à T* = 6/5 pour la donnée initiale étudiée (une rampe croissante entre 1/3 et 3/4).", en: "For an initial datum u₀, the characteristic lines issued from each point ξ follow x(t) = ξ + (1 − 2u₀(ξ))t. As long as these lines do not cross, the solution stays regular; their first crossing defines the critical time T*, computed here as T* = 6/5 for the initial datum studied (an increasing ramp between 1/3 and 3/4)." } },
        { title: { fr: "Choc et relation de Rankine-Hugoniot", en: "Shock and the Rankine-Hugoniot relation" }, body: { fr: "Au-delà de T*, la solution devient discontinue : les caractéristiques se croisent et le profil se referme sur un choc. La relation de Rankine-Hugoniot donne la vitesse du choc S = [f(u)]/[u] à partir des deux états extrêmes (1/3 et 3/4), d'où la trajectoire du choc x_S(t) = 1/2 − t/12. La condition d'entropie (f'(u_gauche) > S > f'(u_droite)) confirme qu'il s'agit bien d'un choc physiquement admissible.", en: "Beyond T*, the solution becomes discontinuous: the characteristics cross and the profile collapses into a shock. The Rankine-Hugoniot relation gives the shock speed S = [f(u)]/[u] from the two extreme states (1/3 and 3/4), yielding the shock trajectory x_S(t) = 1/2 − t/12. The entropy condition (f'(u_left) > S > f'(u_right)) confirms this is a physically admissible shock." } },
        { title: { fr: "Schéma de Lax-Wendroff", en: "The Lax-Wendroff scheme" }, body: { fr: "Le schéma de Lax-Wendroff (forme conservative, ordre 2) est implémenté et testé : convergence en maillage (N = 100, 200, 400, 800, courbes quasiment superposées), puis stabilité selon la condition CFL. Pour CFL ≤ 1, la solution reste cohérente et stable ; dès que CFL > 1, de fortes oscillations numériques apparaissent et s'amplifient jusqu'à faire diverger la solution.", en: "The Lax-Wendroff scheme (conservative form, second order) is implemented and tested: mesh convergence (N = 100, 200, 400, 800, curves nearly superimposed), then stability with respect to the CFL condition. For CFL ≤ 1, the solution stays coherent and stable; as soon as CFL > 1, strong numerical oscillations appear and grow until the solution diverges." }, images: [
          { src: "assets/images/projects/conservation-law-shocks/resultat-cfl.jpg", alt: { fr: "Solutions numériques par le schéma de Lax-Wendroff pour plusieurs valeurs de CFL, stables pour CFL ≤ 1 et fortement oscillantes au-delà.", en: "Lax-Wendroff numerical solutions for several CFL values, stable for CFL ≤ 1 and strongly oscillating beyond." }, caption: { fr: "Stabilité du schéma selon la condition CFL", en: "Scheme stability against the CFL condition" } }
        ] },
        { title: { fr: "Résultats", en: "Results" }, body: { fr: "La solution numérique est comparée à la solution exacte avant et après la formation du choc. Avant T* (à T = 1.0), les deux courbes sont presque confondues. Après T* (à T = 1.4), le schéma localise correctement la position du choc, mais fait apparaître une oscillation numérique au voisinage de la discontinuité, un comportement classique pour un schéma d'ordre 2 non monotone.", en: "The numerical solution is compared with the exact solution before and after shock formation. Before T* (at T = 1.0), the two curves are nearly indistinguishable. After T* (at T = 1.4), the scheme correctly locates the shock's position, but a numerical oscillation appears near the discontinuity, a behaviour typical of a non-monotone second-order scheme." }, images: [
          { src: "assets/images/projects/conservation-law-shocks/comparaison-avant-choc.jpg", alt: { fr: "Comparaison de la solution exacte et de la solution numérique à T = 1.0, avant la formation du choc : les deux courbes sont presque confondues.", en: "Comparison of the exact and numerical solutions at T = 1.0, before shock formation: the two curves are nearly indistinguishable." }, caption: { fr: "Avant le choc (T = 1.0) : solution numérique quasi confondue avec l’exacte", en: "Before the shock (T = 1.0): numerical solution nearly matching the exact one" } },
          { src: "assets/images/projects/conservation-law-shocks/comparaison-apres-choc.jpg", alt: { fr: "Comparaison de la solution exacte et de la solution numérique à T = 1.4, après la formation du choc : le choc est bien localisé, avec une légère oscillation numérique.", en: "Comparison of the exact and numerical solutions at T = 1.4, after shock formation: the shock is well located, with a slight numerical oscillation." }, caption: { fr: "Après le choc (T = 1.4) : choc bien localisé, légère oscillation numérique", en: "After the shock (T = 1.4): well-located shock, slight numerical oscillation" } }
        ] }
      ],
      documents: [
        { type: "pdf", label: { fr: "Rapport du projet (PDF)", en: "Project report (PDF)" }, href: "assets/documents/reports/conservation-law-shocks-report.pdf", available: true },
        { type: "repository", label: { fr: "Code source (GitHub)", en: "Source code (GitHub)" }, href: "https://github.com/honou-jean/lax-wendroff-lois-de-conservation-et-chocs", available: true }
      ]
    }
  }
};
