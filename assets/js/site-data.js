...
window.SITE_DATA = {
  ...
  projectDetails: {
    ...
    "dashboard-prets-immobiliers": {
      ...
      coverImage: { src: "assets/images/projects/dashboard-prets-immobiliers/cover.jpg", alt: { fr: "Capture d’écran du dashboard Power BI : historique des demandes de prêts et taux d’acceptation par année.", en: "Screenshot of the Power BI dashboard: loan request history and acceptance rate by year." } },
      media: [
        { src: "assets/images/projects/dashboard-prets-immobiliers/resultat-score-emprunteur.jpg", alt: { fr: "Table des demandes avec le score emprunteur calculé : accord ou refus par demande.", en: "Requests table with the calculated borrower score: approved or rejected per request." }, caption: { fr: "Résultat : décision accord/refus par demande, calculée automatiquement", en: "Result: approve/reject decision per request, calculated automatically" } },
        { src: "assets/images/projects/dashboard-prets-immobiliers/resultat-taux-acceptation.jpg", alt: { fr: "Taux d’acceptation des prêts par agence, de 64,71 % à 81,48 %.", en: "Loan acceptance rate by branch, from 64.71% to 81.48%." }, caption: { fr: "Résultat : taux d’acceptation par agence (64,71 % à 81,48 %)", en: "Result: acceptance rate by branch (64.71% to 81.48%)" } },
      ...
      sections: [
        ...
        { title: { fr: "Résultats", en: "Results" }, body: { fr: "Sur les 200 demandes suivies, 21 991 097 € de montant total d’opérations. Le taux d’acceptation varie de 64,71 % (Quimper) à 81,48 % (Rennes) selon les agences, un écart que le dashboard rend immédiatement visible sur la carte et le graphique de comparaison.", en: "Across the 200 tracked requests, €21,991,097 in total operation amount. The acceptance rate ranges from 64.71% (Quimper) to 81.48% (Rennes) across branches, a gap the dashboard surfaces immediately on the map and the comparison chart." }, note: { fr: "Le score emprunteur calculé en DAX affecte automatiquement ACCEPTE ou REFUS à chaque demande, visible directement dans le tableau de suivi.", en: "The DAX-calculated borrower score automatically assigns ACCEPTE or REFUS to each request, visible directly in the tracking table." } },
