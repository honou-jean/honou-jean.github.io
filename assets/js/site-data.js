  ...
  projectDetails: {
    "multimodal-biometrics": {
      ...
      sections: [
        ...
        { title: { fr: "Simulateur de fusion", en: "Fusion simulator" }, type: "interactive", component: "fusion-simulator", body: { fr: "Ajustez trois scores de confiance illustratifs et un seuil d’acceptation pour voir la fusion pondérée et la courbe ROC se recalculer en direct.", en: "Adjust three illustrative confidence scores and an acceptance threshold to watch the weighted fusion and ROC curve recompute live." }, note: { fr: "Scores et courbe ROC synthétiques, à visée pédagogique — pas les résultats réels du mémoire, publiés séparément après validation.", en: "Synthetic scores and ROC curve, for teaching purposes — not the thesis's real results, which are published separately once validated." } },
